...
if ($_POST['psq_cid'])
{
    ...
    $dados = Subgrupo_financeiroDAO::selectAll(null, 'descricao like \'%'.$_POST['psq_cid'].'%\'');  
    $g = new TGrid('gd', 'Subgrupos Financeiros cadastrados', $dados, null, null, 'codigo', null, 15, null);
