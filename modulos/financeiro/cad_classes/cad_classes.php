...
$frm = new TForm('Cadastro de classes financeiras', 530, 1000);
...
function callbackModaBox(data, doc )
{
    ...
    {
        if (fwConfirm('Deseja excluir a classe financeira ?',
                function(r) {
                    if (r == true)
                    {
                             fwAjaxRequest({
