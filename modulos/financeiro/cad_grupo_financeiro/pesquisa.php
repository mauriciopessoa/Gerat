...
<script>
    ...
    {
        fwGetGrid('financeiro/cad_grupo_financeiro/cad_grupo_financeiro.php', 'html_gride', {"action": "criar_gride", "psq_cid": ""});
    ...
    {
        if (fwConfirm('Deseja cancelar o grupo financeiro?',
                function(r) {
                    if (r == true)
                    {
                        fwAjaxRequest({
