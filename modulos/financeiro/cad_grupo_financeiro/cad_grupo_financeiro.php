...
$frm = new TForm('Cadastro de grupo financeiro', 530, 1000);
...
function callbackModaBox(data, doc )
{
    ...
    {
        if (fwConfirm('Deseja excluir o grupo financeiro ?',
                function(r) {
                    if (r == true)
                    {
                             fwAjaxRequest({
