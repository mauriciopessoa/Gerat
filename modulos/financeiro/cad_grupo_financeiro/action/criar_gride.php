...
if ($_POST['psq_cid'])
{
    ...
    $dados = Grupo_financeiroDAO::selectAll(null, 'descricao like \'%'.$_POST['psq_cid'].'%\'');  
    $g = new TGrid('gd', 'Grupos Financeiros cadastrados', $dados, null, null, 'codigo', null, 15, null);
