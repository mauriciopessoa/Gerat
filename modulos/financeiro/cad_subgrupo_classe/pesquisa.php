...
$frm->addHiddenField('classe', $strLabel,10);
...
if (empty($_POST['psq_cid']))
{
    ...
    $g = new TGrid('gd', 'Subclasse financeira cadastrado', $dados, null, null, 'codigo', null, 15, null);
...
<script>
    ...
    {
        fwGetGrid('financeiro/cad_subgrupo_classe/cad_subgrupo_classe.php', 'html_gride', {"action": "criar_gride", "psq_cid": ""});
    ...
    {
        if (fwConfirm('Deseja cancelar o subclasse financeira?',
                function(r) {
                    if (r == true)
                    {
                        fwAjaxRequest({
