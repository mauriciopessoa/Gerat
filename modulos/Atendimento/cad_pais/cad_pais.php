...
$frm = new TForm('Cadastro de País', 530, 1000);
...
$frm->addTextField('codigo', 'Código:', 10, false, 10, null, null, null, null, true)->addEvent('onblur', 'buscaPais(this)')->addEvent('onFocus', 'novo()')->setCss('font-size','14px');

$frm->setOnlineSearch('codigo', 'pais'
...
$frm->addTextField('nome', 'País:', 50, true, 30, null, true, null, null, true)->setCss('font-size', '14px')->setCss('text-transform', 'uppercase')->addEvent('onblur', 'upperCase(this)');
...
<script>
    ...
    function buscaPais(campoChave, valorChave)
    {
    ...
    {
        if (fwConfirm('Deseja excluir o país selecionado ?',
                function (r) {
                    if (r == true)
                    {
                        fwAjaxRequest({
