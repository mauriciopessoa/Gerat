...
$menu->add(16,1,'Atendimento',null,null,'folderopen16.gif');
        ...
        $menu->add(37,16,'Classe laudo','atendimento/cad_classe_laudo.php','Cadastro de classe de laudo','folderAzulOpen.gif');
...
$menu->add(19,1,'Financeiro',null,null,'folderopen16.gif');
        ...
        $menu->add(36,19,'Classes financeiras','financeiro/cad_classes/cad_classes.php','Cadastro de classes','folderAzulOpen.gif');
        $menu->add(30,19,'Impostos','financeiro/cad_imposto/cad_imposto.php','Cadastro de imposto','folderAzulOpen.gif');
        $menu->add(34,19,'Grupos Financeiros','financeiro/cad_grupo_financeiro/cad_grupo_financeiro.php','Cadastro de grupo financeiro','folderAzulOpen.gif');
        $menu->add(35,19,'Subclasse Financeira','financeiro/cad_subgrupo_classe/cad_subgrupo_classe.php','Cadastro de subclasse financeira','folderAzulOpen.gif');
        $menu->add(36,19,'Subgrupos Financeiros','financeiro/cad_subgrupo_financeiro/cad_subgrupo_financeiro.php','Cadastro de subgrupo financeiro','folderAzulOpen.gif');
