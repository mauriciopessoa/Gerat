...
$menu->add(19,1,'Financeiro',null,null,'folderopen16.gif');
        ...
        $menu->add(35,19,'Subgrupos Financeiros','financeiro/cad_subgrupo_financeiro/cad_subgrupo_financeiro.php','Cadastro de subgrupo financeiro','folderAzulOpen.gif');
