...
//$frm->addCoordGMSField('num_gms1','Coordenada Geográfica:',false,true,null,null,'NUM_LAT','NUM_LON')->setMapHeaderText('meu cabecalho' )->setMapHeaderFontColor('red')->setMapHeaderFontSize('14px')->setMapCallback('mapCallback')->setMapZoom(10);
