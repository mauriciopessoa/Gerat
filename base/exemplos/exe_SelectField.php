...
$frm->addGroupField('gp1','Selects Normais');
	$frm->addSelectField('sit_cancelado','Cancelado:',null,'0=Não,1=Sim',null,null,'1');
	$frm->addSelectField('seq_bioma'	,'Bioma:',true,'CE=CERRADO,PA=PANTANAL,MA=MATA ATLÂNTICA',null,null,null,true,4);
	$frm->addHtmlField('status');
$frm->closeGroup();


$frm->addGroupField('gp2','Selects Combinados');
	$frm->addSelectField('cod_regiao','Região:',null,'1=NORTE,2=NORDETE,3=SUDESTE,4=SUL,5=CENTRO OESTE')->setEvent('onchange','regiaoChange()');
