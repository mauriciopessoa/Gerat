...
$frm->setOnlineSearch('municipio'
	...
	,'nom_municipio|Município:||||||like'  // campos para seleção do município. Ordem dos parametros: name|label|length|size|required|$type|decimalPlaces|partialKey|searchFormated
	,false
	,false
